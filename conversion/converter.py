...
class ImageApp:
    def __init__(self):
        ...
        buttonLoading = tk.Button(self.left_frame, text="Load Images", command=self.imageHandler.loadImages, width= 14, bg='#8fc9e8')
        buttonLoading.grid(row=0, column=0, sticky="nsew")
        buttonExport = tk.Button(self.left_frame, text="Export Images", command=self.imageHandler.exportImages, width= 14, bg='#8fc9e8')
        ...
        buttonDelete = tk.Button(self.left_frame, text="Delete", command=self.imageHandler.deleteImage, bg='#8fc9e8')
        buttonDelete.grid(row=2, column=0, sticky="nsew")
        buttonDeleteAll = tk.Button(self.left_frame, text="Delete All", command=self.imageHandler.deleteAllImages, bg='#8fc9e8')
        ...
        self.offset_change_date_button = tk.Button(self.left_frame, text="Images Start On", command=self.change_date, bg='#8fc9e8')
        ...
        self.label = tk.Label(self.arrow_frame, text="Pixel Movement Distance", bg='#8fc9e8')
